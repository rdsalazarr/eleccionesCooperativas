...
export default function CerrarElecciones({id, cerrarModal}){
    ...
    const continuar = () =>{
        setLoader(true);
        instance.post('/admin/eleccion/delegado/procesar/evento', {codigo: id, tipo: 'CERRAR'}).then(res=>{
        ...
        <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 8, sm: 8, md: 9}}>
                <p className='mensajeModal'>
                    ¿Esta seguro que desea cerrar estas votaciones?
                </p>
            </Grid>
