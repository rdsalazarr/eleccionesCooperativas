...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={modal?.data?.asocid || null} ruta={'/admin/asociados/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nuevo asociado','Editar asociado',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/asociados/list').then(res=>{
